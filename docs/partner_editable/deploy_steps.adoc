...
. Sign in to your AWS account, and choose *Deploy {partner-product-short-name} into your AWS account* to launch the AWS CloudFormation template.
...
. On the *Specify stack details* page, change the stack name if needed. Review the parameters for the template. Provide values for the parameters that require input. For all other parameters, review the default settings and customize them as necessary. Each deployment takes about {deployment_time} to complete.
